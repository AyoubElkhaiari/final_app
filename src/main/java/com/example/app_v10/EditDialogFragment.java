...
//    private Dialog reRender ;
    private RerenderDialog reRenderDialog;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        reRenderDialog = new RerenderDialog(getActivity());
//        reRender = new Dialog(getContext(), R.style.dialogstyle) ;
//        reRender.setContentView(R.layout.rerender_dialog);
